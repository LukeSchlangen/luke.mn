  ...
  return (
    <>
      <p>
        ...
        it rewarding to give approachable talks for beginners, because everyone is a beginner at something.
      </p>
      <p>
        {isFirstPerson ? ' I ' : ' He '}
        previously taught at a coding bootcamp.
        After that,
        {isFirstPerson ? ' I ' : ' He '}
        led an onboarding program for new software engineers at a Fortune 500 company.
        Now at Google,
      ...
      <p>
        ...
        : a competitive computer coding program for 3<sup>rd</sup> to 9<sup>th</sup> grade students.
      </p>
    </>
  )
}
