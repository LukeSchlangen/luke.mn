        ...
        <div className="flex-1 flex flex-col justify-center space-y-[0.8em] py-[0.5em] h-full overflow-hidden w-full max-w-[88%] mx-auto">
          <div className="flex-1 flex flex-col justify-center overflow-visible">
            {questionData.answers.map((ans, i) => {
              const isHighlighted =
                phase !== "edit" && phase >= 1 && phase <= 4 && phase - 1 === i;
              ...
              return (
                ...
                >
                  ...
                  >
                    <span
                      className={`rounded-full border flex items-center justify-center transition-colors duration-300 w-[2em] h-[2em] text-[0.85em] font-black shrink-0 ${
                        isCorrectHighlighted
  ...
  return (
    <div className={`w-full min-h-screen ${textColorClass} pb-12`}>
      ...
      <div className="mx-auto w-full max-w-[1700px] px-4 mt-6">
        <div
          className={`grid grid-cols-1 ${hidePanels ? "" : "xl:grid-cols-12"} gap-6 items-start`}
        >
